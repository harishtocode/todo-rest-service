...
const debug = require('debug')('todo-service:server');
const packageJ = require('../package.json');
const http = require('http');
// fill node process env
...
function serverListenHandler() {
    ...
    debug(`${process.title} service listening`);
    logger.info(`${process.title} service listening`);
}
...
function main() {
    ...
    // Tag the process by setting its title to the package name
